...
export default class App extends React.Component {
  ...
  toggleCompleted(todoId) {
    const isIndex = obj => obj.todoId === todoId;
    const index = this.state.todos.findIndex(isIndex);
    const updatedIsCompleted = this.state.todos[index].isCompleted === true ? { isCompleted: false } : { isCompleted: true };
